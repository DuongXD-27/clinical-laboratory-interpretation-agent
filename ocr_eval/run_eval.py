...
Usage (from project root):
    python ocr_eval/run_eval.py
    python ocr_eval/run_eval.py --png-dir ocr_eval/png_v2 --report ocr_eval/report_v2.md

Output:
    ocr_eval/report.md  (or the path given by --report)
"""
...
def generate_report(m: dict, results: list[dict], run_ts: str) -> str:
    ...
    a(f"**Test images:** `ocr_eval/png/` (20 PNG files)  ")
    a(f"**Ground truth:** `ocr_eval/mock_data.json`  ")
    ...
    a("---")
    a("")
    a("*Report generated by `ocr_eval/run_eval.py`. Do not edit manually — re-run the script to refresh.*")
